...
import "./ShowArchivedFullNoteWidget.css"
...
const ShowArchivedFullNoteWidget = ({ note }) => {
  ...
  const handleEdit = () => {
    ...
    setSnackbarMessage("To Update the note unarchive the note and update");
  ...
  return (
    <>
    <div className='rounded-md h-full ml-10 w-full p-3 relative' style={{
...
export default ShowArchivedFullNoteWidget